...
public class ImageProcessingService {
     ...
     *                     null for PNG)
     * @param callback     Callback to handle progress updates and results
     */
    public static void processImage(String imagePath, Integer targetSizeKB, ProcessingCallback callback) {
        ...
        Task<String> task = new Task<String>() {
            ...
            protected String call() throws Exception {
                callback.onProgress("Processing image...");
                ...
                if (extension.toLowerCase().equals(".png")) {
                    return convertPngToJpg(srcImg, callback);
                } else {
                    if (targetSizeKB == null) {
                        return "Please set the target file size in KB for JPEG compression.";
                    }
                    return compressJpeg(srcImg, targetSizeKB, callback);
                }
            }
        };
    ...
    private static String convertPngToJpg(String srcImg, ProcessingCallback callback) {
        try {
            callback.onProgress("Converting PNG to JPG...");
            ...
            callback.onProgress("Conversion completed!");
    ...
    private static String compressJpeg(String srcImg, int sizeThreshold, ProcessingCallback callback)
            throws IOException {
        callback.onProgress("Starting JPEG compression...");
        ...
        while (fileSize / 1024 > sizeThreshold && quality > 0.1f) {
            ...
            callback.onProgress("Compressing... Quality: " + String.format("%.1f", quality * 100) + "%");
        ...
        writer.dispose();
        callback.onProgress("Compression completed!");
